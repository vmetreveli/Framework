...
### SensitiveDataAnalyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [SensitiveDataAnalyzer.Sample.csproj](../SensitiveDataAnalyzer.Sample/SensitiveDataAnalyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### SensitiveDataAnalyzer.Tests
