    ...
    where TId : notnull
{
    ...
    /// <summary>
    /// Determines whether the specified <see cref="EntityBase{TId}"/> is equal to the current <see cref="EntityBase{TId}"/>.
    /// </summary>
    /// <param name="other">The <see cref="EntityBase{TId}"/> to compare with the current <see cref="EntityBase{TId}"/>.</param>
    /// <returns>true if the specified <see cref="EntityBase{TId}"/> is equal to the current <see cref="EntityBase{TId}"/>; otherwise, false.</returns>
