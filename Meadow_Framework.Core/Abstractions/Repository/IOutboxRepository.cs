...
namespace Meadow_Framework.Core.Abstractions.Repository;
...
public interface IOutboxRepository
{
    ...
    void CreateOutboxMessage(Outbox_OutboxMessage outboxMessage);
    ...
    Task<List<Outbox_OutboxMessage>> GetAllReadyToSend();
